...
namespace RavenDBPOC
{
    public class HashTagRepositoryTests
    {
        ...
        {
            const string hashTagId = "64ad53242cc2440ea597518294dcef06";
            const int hashTagSize = 5_000_000;

            var firstPage = HashTagRepository.GetNestedEntriesPage2(new PageRequest<string>
            {
                Filter = hashTagId,
                Skip = 0,
                Take = pageSize
            ...
            var hundredthPage = HashTagRepository.GetNestedEntriesPage2(new PageRequest<string>
            {
                Filter = hashTagId,
                Skip = 99 * pageSize,
                Take = pageSize
